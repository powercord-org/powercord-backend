    ...
    getSomeone: async (req, res) => {
      ...
      res.json({
        ...
        customization: {
          ...
          custom: req.config.admins.includes(user.id) /* || user.donor */ ? (user.badges && user.badges.custom ? user.badges.custom : 'https://powercord.xyz/assets/badges/donator.svg') : null,
          customWhite: req.config.admins.includes(user.id) /* || user.donor */ ? (user.badges && user.badges.customWhite ? user.badges.customWhite : 'https://powercord.xyz/assets/badges/donator-w.svg') : null,
