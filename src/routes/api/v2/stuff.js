class Stuff {
  ...
  plug (req, res) {
    ...
    res.send(this._makePlug(req.params.color));
  }

  cute (req, res) {
    switch (req.params.id) {
      case '176580265294954507':
      case '273169968202252289':
        res.json({ cute: false });
        break;
      case '170914719308316672':
      case '215067938452013056':
        res.json({
          cute: true,
          percent: 1337,
          uwu: '🌺'
  ...
  _makePlug (color) {
    return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 447 447">
  ...
  <path fill="#${color}" d="M161.2,327.6l-92.9-92.9c-14.3-14.3-14.3-37.6,0-51.9l85.1-85.1l144.8,144.8l-85.1,85.1 C198.8,342,175.5,342,161.2,327.6z"/>
